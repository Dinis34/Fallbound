...
- To ensure effective mutation testing, we excluded the [LanternaGUI](../src/main/java/Fallbound/GUI/LanternaGUI.java) and [Game](../src/main/java/Fallbound/Game.java) classes. LanternaGUI could conflict with Pitest due to its use of Lanterna, while testing the Game class, which runs the main function and game 
...
This project was inspired by the game [Downwell](https://store.steampowered.com/app/360740/Downwell/), developed by Moppin and published by Devolver Digital. <br>
The game's structure was mainly inspired on the Hero example presented in the classes. Some parts were also based on: https://github.com/FEUP-LDTS-2023/project-l04gr03 
